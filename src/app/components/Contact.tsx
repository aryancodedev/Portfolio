...
export function Contact() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center justify-center px-8 bg-gradient-to-b from-black via-gray-950 to-black overflow-hidden">
      ...
      <motion.div className="relative z-10 max-w-6xl mx-auto w-full" style={{ scale }}>
        <motion.div
        ...
        >
          {/* Status badge */}
          <motion.div
            className="inline-flex items-center gap-2 px-6 py-2 rounded-full mb-12 backdrop-blur-xl border border-green-500/20"
            style={{
          ...
          >
            ...
            />
            <span className="text-green-200 tracking-wider uppercase" style={{ fontSize: '0.75rem', letterSpacing: '0.15em' }}>
        ...
        >
          <div className="relative p-12 rounded-3xl border border-white/10 bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-xl overflow-hidden">
            {/* Static background */}
            <motion.div
            ...
            <div className="relative">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
              >
                <div className="flex items-center justify-between p-8 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm overflow-hidden relative">
                  <motion.div
                  ...
                  <div className="relative flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-gray-400 mb-1" style={{ fontSize: '0.85rem' }}>
                        Primary Contact
                      </p>
                      <p className="text-white" style={{ fontSize: 'clamp(1.2rem, 2.5vw, 1.8rem)', fontWeight: 600 }}>
                        aryanthakur2307@gmail.com
                      </p>
                    </div>
                  </div>

                  <ArrowUpRight className="relative w-6 h-6 text-blue-400 group-hover/email:translate-x-1 group-hover/email:-translate-y-1 transition-transform" />
                </div>
              </motion.a>
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <span className="text-gray-500 uppercase tracking-wider" style={{ fontSize: '0.75rem' }}>or connect via</span>
                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent" />
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {socialLinks.map((link, index) => (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="relative p-6 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm flex flex-col items-center gap-3 overflow-hidden">
                      {/* Hover glow */}
                      <motion.div
                      ...
                      {/* Icon */}
                      <motion.div
                        className={`relative w-12 h-12 rounded-xl bg-gradient-to-br ${link.color} flex items-center justify-center`}
                        whileHover={{ rotate: 360 }}
                        transition={{ duration: 0.6 }}
                      >
                      ...
                      {/* Name */}
                      <span className="relative text-gray-300 group-hover/social:text-white transition-colors" style={{ fontSize: '0.9rem', fontWeight: 500 }}>
                        {link.name}
                      </span>
                    </div>
                  </motion.a>
        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full border border-white/5 bg-white/[0.02] backdrop-blur-sm">
            <motion.div
