...
export function Skills() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 px-8 bg-black overflow-hidden">
      {/* Animated grid background with scroll parallax */}
      <motion.div
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 px-6 py-2 rounded-full mb-8 backdrop-blur-xl border border-emerald-500/20"
            style={{
          ...
          >
            ...
            <span className="text-emerald-200 tracking-wider uppercase" style={{ fontSize: '0.75rem', letterSpacing: '0.15em' }}>
              Tech Stack
            </span>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {skillCategories.map((category, catIndex) => (
            ...
            >
              {/* Card container */}
              <div className="relative h-full rounded-3xl border border-white/10 bg-gradient-to-br from-gray-900 to-black p-8 overflow-hidden">
                    ...
                    {category.skills.map((skill, skillIndex) => (
                      ...
                      >
                        ...
                        >
                          ...
                          {/* Skill name */}
                          <span className="text-gray-300 group-hover/skill:text-white transition-colors" style={{ fontSize: '0.95rem' }}>
                            {skill}
                          </span>
