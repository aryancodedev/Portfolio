      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-16 sm:mb-24">
          ...
          >
            ...
            <div
              className="absolute inset-x-0 bottom-0 top-14 sm:top-20 rounded-3xl border border-white/10 bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-md z-0 transition-all duration-500 group-hover:border-blue-500/30"
            ...
            >
              <div className="relative h-full p-6 sm:p-8 rounded-3xl border border-white/5 bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-sm overflow-hidden">
                ...
                <div className="relative">
                  {/* Icon */}
                  <motion.div
                    className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 border border-white/10 flex items-center justify-center mb-4 sm:mb-6"
                    whileHover={isMobile ? {} : { scale: 1.1, rotate: 5 }}
                    transition={{ type: "spring", stiffness: 300 }}
                  >
                    <div className="text-blue-400 scale-75 sm:scale-100">
                      {principle.icon}
                    </div>
                  </motion.div>
                  ...
                  <h3
                    ...
                    style={{ fontSize: 'clamp(1.2rem, 2.5vw, 1.8rem)', fontWeight: 700 }}
                  >
                    {principle.title}
                  </h3>
                  ...
                  {/* Description */}
                  <p
                    className="text-gray-400 leading-relaxed text-[0.9rem] sm:text-[1.05rem]"
                  >
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8, delay: isMobile ? 0.05 : index * 0.15 + 0.3 }}
                  />
                </div>
              </div>
            </motion.div>
        ...
        >
          <div className="inline-block px-6 py-5 sm:px-8 sm:py-6 rounded-2xl border border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-purple-500/5 backdrop-blur-sm">
            <p
              className="text-gray-300 max-w-3xl text-[0.95rem] sm:text-[1.1rem] md:text-[1.3rem]"
